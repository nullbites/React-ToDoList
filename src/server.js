...
const authCheck = jwt({
  secret: jwks.expressJwtSecret({
        ...
        jwksUri: "https://gravityboom.auth0.com//.well-known/jwks.json"
    }),
    // This is the identifier we set when we created the API
    audience: 'https://chole-the-god.com',
    issuer: 'https://gravityboom.auth0.com/',
    algorithms: ['RS256']
});

app.get('/api/jokes/food', authCheck, (req, res) => {
  let foodJokes = [
  {
    id: 99991,
